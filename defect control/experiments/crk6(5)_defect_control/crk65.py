...
def rk_defect_control(fun, t_span, y0, tol):
    ...
    while xn < xend:
        ...
        defect_sample_1 = abs( 
            crk6.prime(x_sample_1) - fun( x_sample_1, crk6.eval(x_sample_1) )[0] 
        )

        x_sample_2 = x_i + 0.8 * h_i
        defect_sample_2 = abs(
            crk6.prime(x_sample_2) - fun( x_sample_2, crk6.eval(x_sample_2) )[0]
        )
        ...
        if max_defect < tol:
            ...
            # create interps and append to continuous solution here
    ...
    return (
        ...
        continous_sol.eval,
        continous_sol.prime,
        continous_sol.create_defect_sampling()
    )
