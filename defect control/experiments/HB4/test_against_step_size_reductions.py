...
def experiments():
    (hs_1, max_defects_1, max_defects_horner_1) = perfect_convergence(model1, solution1, 1)
    (hs_2, max_defects_2, max_defects_horner_2) = perfect_convergence(model2, solution2, 2)
    (hs_3, max_defects_3, max_defects_horner_3) = perfect_convergence(model3, solution3, 3)
    (hs_6, max_defects_6, max_defects_horner_6) = perfect_convergence(model6, solution6, 6)
    (hs_7, max_defects_7, max_defects_horner_7) = perfect_convergence(model7, solution7, 7)
    (hs_11, max_defects_11, max_defects_horner_11) = perfect_convergence(model11, solution11, 11)
