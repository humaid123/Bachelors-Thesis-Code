from HB8_first_scheme import d0, d1, d2, d3, d4, d5, d6, d7, d0_prime, d1_prime, d2_prime, d3_prime, d4_prime, d5_prime, d6_prime, d7_prime
...
for alpha in values:
    for beta in values:
        ...
        # the first four evaluations are the evalutions of the septic itself at 
        # the next four evaluations are evaluations of its derivatives at 
        computed_values = []
        for i in range(8):
            res = [
                ds[i](1, alpha, beta),
                ds[i](0, alpha, beta),
                ds[i](-alpha, alpha, beta),
                ds[i](gamma, alpha, beta),
                d_primes[i](1, alpha, beta),
                d_primes[i](0, alpha, beta),
                d_primes[i](-alpha, alpha, beta),
