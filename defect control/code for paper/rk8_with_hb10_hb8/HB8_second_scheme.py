...
class HB8ContinuousSolution:
    ...
    def eval(self, x) -> float:
        ...
        # print(f"hb8 eval - ERROR: {x} is outside of the solution range: {first_hb.x_i_minus_2} <= x <= {self.interps[-1].x_i_plus_1}")
        return -1
    ...
    def prime(self, x) -> float:
        ...
        # print(f"hb8 prime - ERROR: {x} is outside of the solution range: {first_hb.x_i_minus_2} <= x <= {self.interps[-1].x_i_plus_1}")
        return -1
