...
#     # take second error control step
#     (xn, yn, f_start, h) = first_step(fun, xn, yn, f_start, tol)
#     res.append( (xn, yn) )
#     fn_s.append(f_start)
...
def rk_defect_control_static_alpha_beta_func_call(fun, t_span, y0, tol, solution):
    ...
    while xn < xend:
        ...
        # => one order of accuracy less => f_i_minus_1 = continous_sol.prime(x_i_minus_1)
        f_i_minus_1 = fun(x_i_minus_1, y_i_minus_1)[0]

        x_i_minus_2 = x_i_minus_1 - h
        y_i_minus_2 = continous_sol.eval(x_i_minus_2)
        # => one order of accuracy less => f_i_minus_2 = continous_sol.prime(x_i_minus_2)
