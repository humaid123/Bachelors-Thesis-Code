...
B = [
    (1 - 2*(c2 + c3) + 6*c2*c3)/(12*c2*c3),
    (2*c3-1)/(12*c2*(c3-c2)*(1-c2)),
    (1 - 2*c2)/(12*c3*(c3-c2)*(1-c3)),
    (3 - 4*(c2+c3) + 6*c2*c3)/(12*(1-c2)*(1-c3))
]   

a41 = (c3**2*(12*c2**2 - 12*c2 + 4) -c3*(12*c2**2 - 15*c2 + 5) + (4*c2**2 -6*c2 + 2)) / (2*c2*c3*(3 - 4*(c2+c3) + 6*c2*c3))
a42 = ((-4*c3**2 + 5*c3 + c2 - 2)*(1-c2))/(2*c2*(c3-c2)*(3 - 4*(c2 + c3) + 6*c2*c3))
...
A = [ 
	  ...
	  [c2, 0, 0, 0],
      [
        (c3*(3*c2-c3-4*(c2**2)))/(2*c2*(1-2*c2)),
        (c3*(c3-c2))/(2*c2*(1-2*c2)),
        0,
        0
      ],
      [a41, a42, a43, 0]
