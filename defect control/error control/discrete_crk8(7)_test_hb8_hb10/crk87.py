...
def rk_error_control(fun, t_span, y0, tol, solution):
    # theory:
    ...
    while xn < xend:
        ...
        if error < tol:
            ...
            continous_sol.append(CRK8Interp(k, y_i, x_i, x_i_plus_1))
            lower_continous_sol.append(CRK7Interp(k, y_i, x_i, x_i_plus_1))
