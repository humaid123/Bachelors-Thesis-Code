...
# n_steps = 1000 is enough for h = 1e-2
res, sol, first_deriv, derivs = rk_fixed_step(model3, t_span_3, y0_3[0], 1000)
computed_solutions = [sol(x) for x in t_eval]
h = (t_span_3[1] - t_span_3[0]) / 1000
...
plt.title(f"first derivative for h={h}")
plt.show()
