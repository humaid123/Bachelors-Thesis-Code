...
(times_high_if, res_high_if, nfev_high_if, time_high_if) = experiment_with_if_high('LSODA')
...
# plt.plot(times_high_if, res_high_if[1], label="high_if")
...
# plt.figure(2)
# # plt.plot(times_radau_if[:327], res_radau_if[1], label="radau")
