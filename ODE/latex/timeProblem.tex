...
\subsubsection{Naive solution of the Time dependent discontinuity model in Python}
\begin{figure}[H]
\centering
...
\subsubsection{Naive solution of the Time dependent discontinuity model in Scilab}
\begin{figure}[H]
\centering
...
\subsubsection{Naive solution of the Time dependent discontinuity model in Matlab}
\begin{figure}[H]
\centering
...
\begin{table}[H]
\caption {R Efficiency data for the Time-dependent Discontinuity problem} 
...
\begin{table}[H]
\caption {Python Efficiency data for the Time-dependent Discontinuity problem} 
...
\begin{table}[H]
\caption {Scilab Efficiency data for the Time-dependent Discontinuity problem} 
...
\begin{table}[H]
\caption {Matlab Efficiency data for the Time-dependent Discontinuity problem} 
...
\begin{table}[H]
\caption {R LSODA time-dependent discontinuity tolerance study} \label{tab:tolerance_time_discontinuity_lsoda_R} 
\begin{center}
\begin{tabular}{ c c c }
...
\begin{table}[H]
\caption {Python LSODA time-dependent discontinuity tolerance study} \label{tab:tolerance_time_discontinuity_lsoda_py} 
\begin{center}
\begin{tabular}{ c c c }
tolerance & no discontinuity handling & with discontinuity handling \\ 
0.1 & 79 & 86 \\
...
\begin{table}[H]
\caption {Scilab LSODA time-dependent discontinuity tolerance study} 
