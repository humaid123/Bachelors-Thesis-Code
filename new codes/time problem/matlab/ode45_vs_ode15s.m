...
nfev = 0;
options = odeset('RelTol', tolerance, 'AbsTol', tolerance);
[t,y] = ode15s(@(t, y) f_with_if(t, y), tspan, y0, options);
plot(t, y(:, 3), 'lineWidth', 1.5);
hold on;
nfevs_ode15s = [nfev];
...
hold off;
legend("ode45\_1e-1", "ode45\_1e-2", "ode45\_1e-3", "ode45\_1e-4", "ode45\_1e-5", "ode45\_1e-6", "ode45\_1e-7", "ode15s\_1e-1", "ode15s\_1e-2", "ode15s\_1e-3", "ode15s\_1e-4", "ode15s\_1e-5", "ode15s\_1e-6", "ode15s\_1e-7");
A = [tolerances; nfevs; nfevs_ode15s];
transpose(A)
